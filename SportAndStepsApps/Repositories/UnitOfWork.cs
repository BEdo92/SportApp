...
public class UnitOfWork(SportsContext context, IUserRepository userRepository,
    IUserActivityRepository userActivityRepository, ISportTypeRepository sportRepository) : IUnitOfWork
{
    public IUserRepository UserRepository => userRepository;

    public IUserActivityRepository UserActivityRepository => userActivityRepository;

    public ISportTypeRepository SportRepository => sportRepository;
